...
export const api = {
  ...
  mfaSetup: (mfaToken: string) => api.request<{ secret: string; otpauthUri: string; periodSeconds: number }>('/auth/mfa/setup', { method: 'POST', body: JSON.stringify({ mfaToken }) }),
  ...
  updateContact: (id: string, data: unknown) => api.request(`/contacts/${id}`, { method: 'PATCH', body: JSON.stringify(data) }),
  deleteContact: (id: string) => api.request(`/contacts/${id}`, { method: 'DELETE' }),
  optOutContact: (id: string) => api.request(`/contacts/${id}/opt-out`, { method: 'POST' }),
  importContacts: (contacts: unknown[]) => api.request<{ imported: number; failed: number }>('/contacts/import', { method: 'POST', body: JSON.stringify({ contacts }) }),
  ...
  branding: () => api.request<{ logoDataUrl?: string | null }>('/branding'),
  ...
  createSegment: (data: unknown) => api.request('/segments', { method: 'POST', body: JSON.stringify(data) }),
  deleteSegment: (id: string) => api.request(`/segments/${id}`, { method: 'DELETE' }),
  createCampaign: (data: unknown) => api.request('/campaigns', { method: 'POST', body: JSON.stringify(data) }),
  sendCampaign: (id: string) => api.request(`/campaigns/${id}/send`, { method: 'POST' }),
};
